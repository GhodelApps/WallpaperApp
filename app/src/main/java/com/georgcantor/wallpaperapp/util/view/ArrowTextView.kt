...
import com.georgcantor.wallpaperapp.databinding.ViewTextWithRightArrowBinding
...
class ArrowTextView @JvmOverloads constructor(
    ...
    private val binding =
        ViewTextWithRightArrowBinding.inflate(LayoutInflater.from(context), this, true)
